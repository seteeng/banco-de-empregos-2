...
?>
												...
												<td>
												<?php echo anchor('admin/users/edit/'.$user->id, "<span class=\"glyphicon glyphicon-pencil\"></span>"); ?>
												&ensp;
												<?php echo anchor('admin/users/profile/'.$user->id, "<span class=\"glyphicon glyphicon-search\"></span>"); ?>
												</td>
											</tr>
<?php endforeach;?>
										</tbody>
